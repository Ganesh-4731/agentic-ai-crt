...
API_KEY = os.getenv("OPENWEATHERMAP_API_KEY", "REPLACE_WITH_OPENWEATHERMAP_API_KEY")

# 🔑 Groq API Key (set in environment for safety)
# export GROQ_API_KEY="your_key"
client = Groq(api_key=os.getenv("GROQ_API_KEY", "REPLACE_WITH_GROQ_API_KEY"))  # <-- replace here or use env
